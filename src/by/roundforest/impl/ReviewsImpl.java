...
public class ReviewsImpl implements Reviews{
	...
	public List<WordBean> getMostUsedWords(int count) {
		...
		TreeSet<WordBean> wordsSet = jdbcTemplate.query(sqlAll, new ResultSetExtractor<TreeSet<WordBean>>(){
		  @Override
		  public TreeSet<WordBean> extractData(ResultSet rs) throws SQLException, DataAccessException {
